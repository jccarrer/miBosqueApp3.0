...
public class dbfrutas : MonoBehaviour
{
    ...
    void sqlite_conexion()
    {
        ...
        string sqlQuery = "SELECT * FROM frutas";
        ...
        while (reader.Read())
        {
            ...
            string ruta = reader.GetString(2);
    ...
    public string sqlite_consulta(String consulta)
    {
        ...
        while (reader.Read())
        {
            ...
            consulta = ruta;  //Asigna la ruta guardada en la base a la consulta que se devuelve
