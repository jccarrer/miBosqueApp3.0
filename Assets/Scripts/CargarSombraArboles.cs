...
public class CargarSombraArboles : MonoBehaviour
{
    public Image sombra;
    public string animal;
//    private dbarboles objdb;
    private string monoBase, rataBase, osoBase, venadoBase;
    public Image i1, i2, i3, i4;

    public GameObject param;
    private Parametrosarboles prm;


    string[] sombras = {
        "Sprites/mango-sombra",
        "Sprites/tamarindo-sombra",
        "Sprites/saman-sombra",
        "Sprites/palo_santo-color"
    };
