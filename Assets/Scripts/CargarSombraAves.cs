...
public class CargarSombraAves : MonoBehaviour
{
    public Image sombra;
    ...
    string[] sombras = {
        "Sprites/papagayo_guayaquil-sombra",
        "Sprites/carpintero_carinegro-sombra",
        "Sprites/golondrina_azul_y_blanca-sombra",
