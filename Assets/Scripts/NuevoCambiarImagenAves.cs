...
public class NuevoCambiarImagenAves : MonoBehaviour
{
    ...
    string[] animales = {
        "Sprites/papagayo_guayaquil-color",
        "Sprites/carpintero_carinegro-color",
        "Sprites/golondrina_azul_y_blanca-color",
        "Sprites/urraca_coliblanca-color"
    };
